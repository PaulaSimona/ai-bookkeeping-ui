        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          ...
          {hasTier2 && (
            <>
              ...
              {/* §INV (S41): Invoices after Suppliers (invoices ⇄ clients). */}
              <NavItem to="/accounting/invoices" label="Invoices" icon="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" />
              ...
              {/* O-S41-8: Business identity (invoice bill-from) — a settings
                  surface beside Tax Profile. Glyph inlined (office-building). */}
              <NavItem to="/accounting/business-identity" label="Business identity" icon="M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" />
