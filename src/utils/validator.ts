...
export const VALIDATION_MESSAGES = {
  ...
  MATCH_PASSWORD: "Doesn't match password",
};
...
export const isValid = (errors: errorType): boolean => {
  let valid = true;
    ...
    fields[key].forEach((field) => {
      switch (field) {
        ...
        case VALIDATION.SECURE_PASSWORD:
          ...
          break;
        case VALIDATION.MATCH_PASSWORD:
          if (data[key] !== data.password) {
            errors[key].push(VALIDATION_MESSAGES.MATCH_PASSWORD);
          }
          break;
        default:
          break;
