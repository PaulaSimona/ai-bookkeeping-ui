      ...
      <div className="min-h-screen bg-[#0f172a] text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="rounded-2xl bg-[#0A1628] border border-white/10 p-6 hover:border-white/20 transition-colors">
                ...
                <p className="text-sm text-white/50 leading-relaxed">
                  Manage receipts, track expenses by category, and generate GST/HST tax reports — all ready for your accountant.
                </p>
              </div>
        ...
        <section className="px-6 py-12 border-t border-white/8">
          <div className="max-w-6xl mx-auto flex flex-col items-center gap-6">
            <p className="text-xs uppercase tracking-wider text-white/40">Featured On</p>
